...
- `Relatório.pdf` — relatório descritivo do projeto.
...
7. **Executar:** dê `reset`, mantenha `load_enable = 0` e acione o clock.
   ...
   `reg_debug_o` (leitura dedicada: mostra qualquer registrador a qualquer
   momento). Na versão SIMD, o mesmo `reg_sel_i` seleciona o registrador
   vetorial cujas 4 lanes aparecem em `vec_lane0..3_debug_o`.
